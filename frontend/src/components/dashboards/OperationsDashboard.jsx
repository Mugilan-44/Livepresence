  ...
  return (
    <div className="space-y-5">
      <section className="glass-card p-5 lg:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <p className="text-sm font-semibold text-slate-900 dark:text-white">Team operations</p>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Priorities, requests and team context for today.</p>
        </div>
        ...
        <div className="glass-card p-5 lg:p-6">
          <div className="flex items-center justify-between gap-4 mb-5">
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">Choose an operational task to continue.</p>
            </div>
